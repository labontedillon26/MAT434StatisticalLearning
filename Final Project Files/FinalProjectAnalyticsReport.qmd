...
The best model class we explored was the random forest model with an accuracy mean of about $94 \%$ from cross validation ($5$ folds). Let's fit this model to a couple data sets and see how our model performs.
